const comboStrategies = [
  {
    ...
    '🟢 [Momentum Rebound] Возможен быстрый отскок. Вход по рынку.'
  },
  {
    ...
    direction: "long",
    message: (symbol, timeframe) =>
    '📈 [Volume Breakout] Пробой с объёмом. Рассматривай вход на импульсе.'
  },
  {
    name: "Exhaustion Top",
    ...
    direction: "short",
    message: (symbol, timeframe) =>
    '🔻 [Exhaustion Top] Перекупленность и выгорание — возможен разворот.'
  },
  {
    ...
    direction: "long",
    message: (symbol, timeframe) =>
    '🟢 [Bullish Divergence] Дивергенция — возможен отскок вверх.'
  },
  {
    ...
    direction: "short",
    message: (symbol, timeframe) =>
    '🟡 [Mean Reversion] Цена выше нормы. Ожидается возврат к MA.'
  },
  {
    ...
    direction: "short",
    message: (symbol, timeframe) =>
    '🔻 [Dead Volume Fall] Объём падает на спаде — снижение может усилиться.'
  }
];
