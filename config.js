module.exports = {
 ...
 // === EMA Settings ===
  EMA_PERIOD: 21, // период EMA для расчёта наклона (обычно 21 — среднесрочная EMA)
  EMA_DEPTH: 21,  // глубина, через которую измеряется наклон (кол-во свечей между точками сравнения)
