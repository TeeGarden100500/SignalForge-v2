module.exports = [
  ...
  },
  {
    ...
    "direction": "short",
    "message": "🟠 [False Breakout Trap] Ложный пробой вверх. Осторожно, может последовать откат.",
    "explanation": "Цена пробила сопротивление, но быстро вернулась вниз. RSI перекуплен, MACD ослабевает. Возможен разворот. Подходит для оценки шорта или входа в кросс-пару против BTC."
  }
]
