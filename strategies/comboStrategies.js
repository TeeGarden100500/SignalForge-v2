module.exports = [
  ...
  },
  {
    ...
    "direction": "long",
    "message": "🟠 [False Breakdown Trap] Ложный пробой вниз. Возможен возврат вверх.",
    "explanation": "Цена пробила поддержку, но RSI перепродан, а MACD усиливается. Возможен возврат в диапазон или отскок. Рассматривай вход против паники, особенно в альтах против BTC."
  }
]
