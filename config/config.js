...
module.exports = {
  ...
  // ░░░ Волатильность ░░░
  VOLATILITY_TOP_N: 20,     // Сколько монет отбирать по волатильности
  VOLATILITY_TOP_COUNT: 50, // (дублируется для совместимости)
  VOLATILITY_LOOKBACK: 30,  // Сколько минут учитывать при расчете волатильности
  VOLATILITY_REFRESH_INTERVAL_SEC: 3600, // Как часто пересчитывать волатильность (в секундах)
